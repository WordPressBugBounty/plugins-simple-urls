...
<section class="px-3 py-5">
	<div class="lite-container text-center lasso-lite-pro-page">
		...
		<div class="align-items-center">
			...
			<p class="large">Tables are available with Lasso Pro. <a href="<?php echo esc_url( Constant::get_lasso_upgrade_url( 'tables_upgrade_text' ) ); ?>" target="_blank">Click here to upgrade</a>.</p>
...
<div class="modal fade lasso-lite-pro-modal" id="lasso-lite-pro-modal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true" data-keyboard="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content text-center">
			...
			<a class="btn lasso-lite-upgrade-btn" href="<?php echo esc_url( Constant::get_lasso_upgrade_url( 'tables_upgrade' ) ); ?>" target="_blank" rel="noopener noreferrer">Enable Now</a>
		</div>
	</div>
</div>
