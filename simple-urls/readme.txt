...
* Added auto-upgrade functionality for Affiliate+ links
...
* Enhanced the ability to connect to Lasso's admin hub: https://app.getlasso.co
* Enabled extra features with a Lasso Startup Plan. Learn more: https://getlasso.co/upgrade
